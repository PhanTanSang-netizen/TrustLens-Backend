...
def analyze_submission_text(
    ...
    if file_record is None:
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail={
                "error_code": "FILE_RECORD_NOT_FOUND",
                "message": "Không tìm thấy metadata file của bài nộp.",
                "details": {
                    "file_id": str(submission.file_id),
                },
            },
        )
    ...
    try:
        ...
        if extracted_document is None:
            extracted_document = ExtractedDocument(
                submission_id=submission_id,
                full_text=extracted_result.full_text,
        ...
        raise HTTPException(
            ...
            detail={
                ...
                "message": "Không thể trích xuất text từ file.",
                "details": {
                    "reason": str(exc),
                },
            },
